 ...
 * @see RadioButton
 *
 * @author https://github.com/valheru7/RelativeRadioGroup
 *
 */
public class RelativeRadioGroup extends RelativeLayout {
    ...
    public RelativeRadioGroup(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            int value = attributes.getResourceId(R.styleable.RelativeRadioGroup_android_checkedButton,
                    View.NO_ID);
            if (value != View.NO_ID) {
                mCheckedId = value;
            }
